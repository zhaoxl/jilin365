...
#     end
    params[:attrs].each do |attr|
      info_attr = @trade_info.trade_info_attrs.find{|ir| ir.trade_info_category_attr_id.to_i == attr[:attr_id].to_i} || @trade_info.trade_info_attrs.build(trade_info_category_attr_id: attr[:attr_id], name: attr[:attr_name], data_type: attr[:data_type])
